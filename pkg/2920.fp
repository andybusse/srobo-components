...
Element[0x00000000 "Standard SMT resistor, capacitor etc" "" "2920" 0 0 -3150 -3150 0 100 ""]
(
# 
# Pad[x1, y1, x2, y2, thickness, clearance, mask, name , pad number, flags]
	Pad[-3.7mm -1.65mm -3.7mm 1.65mm 2.3mm 0.5mm 2.55mm "1" "1" "square"]
	Pad[ 3.7mm -1.65mm  3.7mm 1.65mm 2.3mm 0.5mm 2.55mm "2" "2" "square"]
	ElementLine[-2.35mm -2.7mm 2.35mm -2.7mm 0.2mm]
	ElementLine[-2.35mm  2.7mm 2.35mm  2.7mm 0.2mm]
#
